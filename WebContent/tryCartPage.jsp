...
<script type="text/javascript">
      function function1(a) {
    	  var c_id=a;
    	  var cart_name= document.getElementId("cart_name");
    	  alert("value="+cart_name);
    	  
    	  
    	  
    	  document.location='DeleteController?c_id='+c_id;
      }
  </script>
...
<jsp:include page="header.jsp"></jsp:include>
<div class="col-sm-8 col-lg-9 mtb_20">
          <input type="hidden" id="cart_name" name="cart_name" value="<%= session.getAttribute("cart_name")%>">
          <input type="hidden" name="flag" value="delete"> 
            <div class="table-responsive">
              <table class="table table-bordered">
                <thead>
                ...
                <c:forEach var="i" items="${sessionScope.cartList }">
                <c:set var="cart_name" value="${i.cart_name }" scope="session" />
                 ...
                 <tr> 
                   <td class="text-left"><a href="product.html">${i.cart_p_name}</a></td>
                    ...
                    <td class="text-left">
                      ...
                      <td>
                      <span class="input-group-btn">
                      <input  class="btn btn-danger"  onclick="function1('${i.c_id}');"  value="Remove">
                      </span>
                    </td>
                    <td class="text-right"><input type="hidden" value="${i.unit_price }" name="unit">${i.unit_price }</td>
                    <td class="text-right"><input type="hidden" value="${i.total_price }" name="total">${i.total_price }</td>
